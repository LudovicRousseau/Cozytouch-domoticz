        ...
        for a in data['setup']['devices']:
            ...
            if name == dict_cozytouch_devtypes.get('radiateur'): # on vérifie si le nom du device est connu
               ...
               p+=1 # incrément position dans dictionnaire des devices
                ...
                liste = ajout_chauffe_eau (save_idx,liste,url,x,(data['setup']['rootPlace']['label'])) # label rootplace
                p+=1
                ...
                liste= Add_DHWP_THERM (save_idx,liste,url,x,(data['setup']['rootPlace']['label']),name) # label sur rootplace
                p+=1
